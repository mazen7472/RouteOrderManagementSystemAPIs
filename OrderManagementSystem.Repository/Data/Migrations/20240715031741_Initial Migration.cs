    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "mazen.mohamed@gmail.com", "Mazen Mohamed" },
                    { 2, "sara.khaled@yahoo.com", "Sara Khaled" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 0, new DateTime(2024, 7, 15, 6, 17, 41, 74, DateTimeKind.Local).AddTicks(3205), "Credit Card", "Processing", 100m });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "OrderId", "CustomerId", "InvoiceId", "OrderDate", "PaymentMethod", "Status", "TotalAmount" },
                values: new object[] { 2, 2, 0, new DateTime(2024, 7, 15, 6, 17, 41, 74, DateTimeKind.Local).AddTicks(3260), "PayPal", "Shipped", 200m });

            migrationBuilder.InsertData(
                table: "OrderItems",
                columns: new[] { "OrderItemId", "Discount", "OrderId", "ProductId", "Quantity", "UnitPrice" },
                values: new object[] { 1, 0m, 1, 1, 1, 1200.99m });

            migrationBuilder.InsertData(
                table: "OrderItems",
                columns: new[] { "OrderItemId", "Discount", "OrderId", "ProductId", "Quantity", "UnitPrice" },
                values: new object[] { 2, 0m, 1, 2, 1, 1400.99m });
